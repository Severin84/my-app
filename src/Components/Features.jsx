...
const Features = () => {
   //   const slides=[
   //      {Fimg1,Fimg2,Fimg3,Fimg4,Fimg5,Fimg6,Fimg7,Fimg8,Fimg9},
   //      // "img2":{Fimg2}
   //   ];
  ...
  return (
    <div>
     ...
     <button className="Ppre-btn" onClick={btnpressprev}><p>&lt;</p></button>
     <button className="Pnext-btn" onClick={btnpressnext}><p>&gt;</p></button> */}
    
     {/* {
        Object.values(arr.img1).map((item)=>(
            <img src={item}/>
        ))
     } */}
